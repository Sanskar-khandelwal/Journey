...
export default function AchivementForm() {
  ...
  return (
    <div className="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-1 col-span-2 w-4/5 h-[550px] mx-auto mt-10 border flex justify-center align-middle sticky top-20">
      <form
        className="bg-white rounded px-5 py-2 w-full"
